# ============================================================
#  PROJETO DETECTIVE — Fase 1 (corrigido)
...
URL_CONCORRENTE = "https://produto.mercadolivre.com.br/MLB-4288664161"
...
try:
    ...
    if resposta.status_code == 200:
        ...
        print("\n⚠️  Erro 403: acesso negado pelo site.")
        ...
        print(f"\n⚠️  Status inesperado: {resposta.status_code}")
